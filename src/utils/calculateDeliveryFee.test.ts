...
describe('In calculateDeliveryFee', () => {
    ...
    let deliveryFeeFormData = {cartValue: "10", deliveryDistance: "1000", numberOfItems: "4"}
    ...
    test("Delivery fee cannot be over 15€", () => {
        deliveryFeeFormData = {cartValue: "1", deliveryDistance: "2000", numberOfItems: "10"}
        expect(calculateDeliveryFee(deliveryFeeFormData, orderTime)).toBe(15)
    })
    test("Free delivery, if cart value is 200€ or more", () => {
        deliveryFeeFormData = {cartValue: "200", deliveryDistance: "2000", numberOfItems: "10"}
